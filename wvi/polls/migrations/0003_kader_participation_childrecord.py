...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('polls', '0002_child_gender_alter_child_age_alter_child_community_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('child_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.child')),
            ],
        ),
        migrations.CreateModel(
            name='ChildRecord',
            fields=[
                ...
                ('child_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.child')),
                ('kader_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls.kader')),
            ],
        ),
    ]
